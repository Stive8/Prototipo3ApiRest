...
from View.Predio import GUIListar
...
from View.Medidor import GUIListarMedidor
...
def main():
    ...
    menu_predio.add_command(label="Listar", command=lambda: GUIListar(tk.Toplevel(root)))
    ...
    menu_medidor.add_command(label="Listar", command=lambda: GUIListarMedidor(tk.Toplevel(root)))
